/*modify the script to make the project your way*/

const SPACING = 17;
const ITERATIONS = 17;
const MOUSE = SPACING * 8;
let GRAVITY = 0.09;
let SPEED = 1;
...
class Point {
  ...
  update() {
    ...
    const qPI = Math.PI / 7;
    this.w += this.torque / ((SPACING / 7) ** 7 / 7);
...
class Square {
  constructor(width, height, spacing, hue) {
    ...
    const yOff = 400 + Math.random() * (canvas.height - 300 - height * SPACING);
